 ...
 * It invokes method to display all unannotated videos in database
 */
public class AnnotateVideoMainAction extends ActionSupport{

	static Logger log = Logger.getLogger(AnnotateVideoMainAction.class);
	...
	public String execute() throws Exception {
		...
		if(ActionConstants.METHOD_GET.equalsIgnoreCase(method)){
			try{
				...
				learningObjects = dbAccessDaoInterface.getUnannotatedVideos();
			...
			//	learningObjects = tdbAccessDaoInterface.removeItemsWithoutStory(learningObjects, TripleStoreConstants.URI_VIDEO);
