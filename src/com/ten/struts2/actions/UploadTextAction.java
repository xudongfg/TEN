	...
	public String execute() throws Exception {
		...
		if(ActionConstants.METHOD_POST.equalsIgnoreCase(method)){
			try{
				...
				this.cloReferenceId = this.digitalRightsManagementBean.getTribe() + "-" + String.format("%06d", textId) + "-" + this.digitalRightsManagementBean.getDateOfUpload().substring(2).replaceAll("-","") + "-" + "Text";
				
				//Insert CLO reference id into Mysql database
				dbAccessDaoInterface.updateLearningObjectReferenceId(textId, this.cloReferenceId);
